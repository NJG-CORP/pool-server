            ...
            @if(count($all_club))
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th>Phone</th>
                        <th>Changed</th>
                        <th class="action-column">Content</th>
                    </tr>
                    </thead>
                    ...
                    @foreach($all_club as $club)
                        ...
                        <tr id="part{{$club->id}}">
                            ...
                            <td>
                                ...
                                <a href="{{route('get:club:edit',['id'=>$club->id])}}">
                                    <button type="button" class="btn btn-primary">Change Club</button>
                                </a>
                                <button type="button" class="btn btn-primary delete" data-id="{{$club->id}}">Delete
                                    Club
                                </button>
