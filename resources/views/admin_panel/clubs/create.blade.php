...
<div class="card-body">
     <form action="{{route('post:club:store')}}" method="POST" id="updated"class="forms-sample" enctype="multipart/form-data">
      {{csrf_field()}}
...
<div class="form-group">
    ...
    <input type="number" class="form-control" id="russian" name="russian" placeholder="Enter Russian"required>
    
  </div>
  <div class="form-group">
    <label for="snooker">Snooker</label>
    <input type="number" class="form-control" id="snooker" name="snooker" placeholder="Enter Snooker"required>
...
<option value="{{$k->id}}">{{$k->name}}</option>
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="location" name="location" placeholder="Enter Location" required>
    
  </div>
  
  <div class="form-group">
    <label for="mob">Phone No.</label>
    <input type="number" class="form-control" id="mob" name="mob" placeholder="Enter phone number" required>
