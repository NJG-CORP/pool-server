...
<input type="text" id="addeventform-title" class="form-control" name="title" aria-required="true" value="{{ $blog->title }}">
...
<input type="text" id="addeventform-url" class="form-control" name="url" aria-required="true" value="{{ $blog->url }}">
...
<textarea id="addeventform-description" class="form-control" name="description" rows="6">{{ $blog->description }}</textarea>
...
@if(count($blog->getMainImageEvent))
    ...
    <button type="button" class="rmImg btn btn-danger btn-small" data-id="{{$blog->getMainImageEvent->id}}"> Remove</button>  
...
<input type="text" id="addeventform-url" class="form-control" name="gallery_title" aria-required="true" value="{{$blog->gallery_title}}">
